          ...
          {handleLogin && (
            ...
            >
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 px-6 py-3.5 bg-slate-900 text-white rounded-2xl font-black text-xs sm:text-sm tracking-wide shadow-[3px_3px_0px_#2D231E] border-2 border-[#2D231E] hover:bg-slate-800 active:translate-y-0.5 active:shadow-[1px_1px_0px_#2D231E] transition-all disabled:opacity-70 cursor-pointer w-full sm:w-auto"
              >
