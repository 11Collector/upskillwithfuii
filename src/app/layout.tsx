...
export const metadata: Metadata = {
  title: "อัพสกิลกับฟุ้ย | แพลตฟอร์มอัปเกรดชีวิตและทักษะ",
  description: "ศูนย์รวมเครื่องมือวิเคราะห์การทำงาน การเงิน และสมดุลชีวิต เพื่อสร้าง Mindset ของคนที่ประสบความสำเร็จ",
};
