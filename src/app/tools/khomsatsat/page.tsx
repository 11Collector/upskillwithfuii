...
const promptText = `
    ...
    1. **กฎความยาวต่อบรรทัด (Visual Symmetry):** ทุกบรรทัดต้องมีความยาว "ใกล้เคียงกัน" เพื่อให้ภาพรวมออกมาเป็นทรงสี่เหลี่ยม (Block Text) 
       - **ห้ามมีบรรทัดไหนยาวเกิน 25 ตัวอักษร (หรือประมาณ 5-8 พยางค์)** เด็ดขาด
       - ความยาวของแต่ละบรรทัด ต้องไม่เกินประโยคนี้: "เคียงข้างเธอไม่ใช่แค่ระยะทาง"
    2. **กฎการห้ามทิ้งเศษคำ (No Orphan Words):** บรรทัดสุดท้าย หรือบรรทัดใดๆ **ห้ามมีเศษคำร่วงลงมาโดดๆ เพียง 1-3 คำเด็ดขาด** (หากเกิดขึ้น ให้เกลาประโยคใหม่ให้ความยาวเฉลี่ยเท่าๆ กัน)
    3. **กฎการจัดวรรค (Phrasing):** 1 บรรทัดต้องจบความหมายในตัว ห้ามทิ้งคำเชื่อม (เช่น ที่, ซึ่ง, อัน, คือ, และ) ไว้ท้ายบรรทัด 
    4. **จำนวนบรรทัด:** บังคับที่ 3 ถึง 5 บรรทัด (ห้ามเกิน 5 บรรทัด)
    5. **บังคับภาษา:** ใช้ภาษาไทย 100% เท่านั้น ห้ามมีภาษาจีนหรือภาษาอื่นปะปน
    6. ห้ามใส่เครื่องหมายอัญประกาศ (" ") หรือ Quote คร่อมคำศัพท์
    7. ห้ามพิมพ์คำอธิบาย พิมพ์แค่ "ตัวข้อความคำคม" ที่ขึ้นบรรทัดใหม่ (\\n) มาอย่างสมบูรณ์เท่านั้น
  `;
