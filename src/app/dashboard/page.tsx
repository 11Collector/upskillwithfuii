...
import { PieChart, Quote, Users, Wallet, ChevronRight, Sparkles, BookOpen, RefreshCw, LogOut, BrainCircuit, Target, AlertCircle, CheckCircle2, Circle, Trophy, Flame, Info, Lock, Unlock, X, Zap, Star,Camera,Download,Ticket,RotateCcw,Shuffle } from "lucide-react"; 
...
{/* 🎯 Level Info Modal - ย้ายมาวางบรรทัดสุดท้ายของไฟล์ Dashboard */}
<AnimatePresence>
  {showLevelInfo && (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      // z-[9999] เพื่อให้ทับทุกอย่างจริงๆ และ fixed inset-0 เพื่อให้เต็มตา
      className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-6 bg-slate-950/90 backdrop-blur-md"
      onClick={() => setShowLevelInfo(false)}
    >
      <motion.div
        ...
        // md:max-w-md = จอคอมกว้างพอดี / max-h-[90vh] = กันล้นจอแนวตั้ง
        className="relative w-full max-w-[350px] md:max-w-md bg-[#0f172a] border border-white/10 p-6 md:p-10 rounded-[2.5rem] shadow-[0_50px_100px_rgba(0,0,0,0.8)] text-left overflow-hidden max-h-[90vh] flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* ✨ Glow Effect ตกแต่งให้ดูพรีเมี่ยม */}
        ...
        <div className="flex justify-between items-center mb-6 shrink-0">
          ...
          <button 
            onClick={() => setShowLevelInfo(false)} 
            className="p-2.5 bg-white/5 hover:bg-white/10 text-slate-400 rounded-2xl transition-all"
          >
            <X size={20} />
          </button>
        </div>

        {/* Content - ส่วนที่เลื่อนขึ้นลงได้ถ้าจอมือถือเล็กจัด */}
        <div className="overflow-y-auto custom-scrollbar pr-1 flex-1">
          <p className="text-[14px] text-slate-400 mb-6 leading-relaxed">
            สะสมทุกๆ <span className="text-yellow-400 font-black">100 XP</span> เพื่ออัพ Level และปลดล็อก Feature รวมถึงสิทธิพิเศษใหม่ๆ
          </p>
          ...
          <div className="grid grid-cols-1 gap-3 mb-8">
            {[
              ...
              <div key={i} className="flex items-center justify-between bg-white/5 p-4 rounded-2xl border border-white/5 group">
                <div className="flex items-center gap-4">
        ...
        {/* Footer - แถบ XP รวม (ติดหนึบด้านล่าง) */}
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-5 rounded-3xl border border-white/10 flex justify-between items-center shadow-2xl shrink-0 mt-4">
          <div className="flex flex-col">
          ...
          <div className="bg-yellow-400 text-slate-950 px-4 py-2 rounded-xl font-black text-lg shadow-[0_10px_20px_rgba(250,204,21,0.2)]">
