...
export const QUEST_POOL = {
  ...
  MONEY: {
  "HIGH_RISK_HIGH_DISC": [
    "🛑 วางมือถือลงห่างตัว 15 นาที เมื่อเกิดอาการ 'อยากซื้อเดี๋ยวนี้!'",
    "🚫 ปิดแอปช้อปปิ้งและล้างหน้าจอ Recent Apps ทันทีที่ไถเพลินเกิน 10 นาที",
    "📝 เขียนข้อดี-ข้อเสียลงกระดาษ 1 แผ่น ก่อนตัดสินใจโอนเงินซื้อของชิ้นใหญ่",
    "✍️ พิมพ์ลง Note มือถือว่าอารมณ์ไหนทำให้เราอยากซื้อของชิ้นล่าสุด (เช่น เครียด, เหงา)",
    "🧮 เอาเงินเดือนหารจำนวนชั่วโมงทำงาน เพื่อคำนวณว่าของที่จะซื้อต้องแลกด้วยเวลาชีวิตกี่ชั่วโมง",
    "✍️ เขียนแผนฉุกเฉิน 1 บรรทัด ว่าถ้าเดือนนี้ตกงาน จะเอาเงินก้อนไหนมาใช้",
    "🎯 เขียนเป้าหมายเก็บเงิน 1 ข้อใส่ Post-it แล้วแปะไว้ที่หน้าโต๊ะทำงาน",
    "🔍 เสิร์ชหาอ่านรีวิว 'ข้อเสีย' ของสิ่งที่กำลังอยากได้ เป็นเวลา 5 นาที",
    "🛡️ กดโอนเงินรายได้พิเศษหรือโบนัสเข้าบัญชีเงินเก็บทันทีอย่างน้อย 10%",
    "💬 พิมพ์แชตปฏิเสธนัดปาร์ตี้หรือมื้ออาหารที่เกินงบในวันนี้ 1 ครั้ง"
  ],
  "MID_RISK_HIGH_DISC": [
    "🖼️ หารูปเป้าหมายการเงิน (เช่น ทริปเที่ยว, บ้าน) มาตั้งเป็น Wallpaper มือถือ 1 วัน",
    "✅ พิมพ์ชมตัวเอง 1 ประโยคลง Note มือถือ ที่วันนี้เบรกตัวเองไม่ให้เสียเงินได้",
    "📸 ถ่ายรูปของ 1 ชิ้นที่ใช้งานสุดคุ้ม เก็บไว้เตือนใจตัวเองว่าไม่ต้องซื้อรุ่นใหม่",
    "🎧 ฟังพอดแคสต์การเงินหรือพัฒนาตัวเองจบ 1 ตอน (ความยาว 10-15 นาที)",
    "🧮 ขีดเส้นแบ่งครึ่งกระดาษ เทียบยอดเงิน 'ซื้อความสุข' กับ 'เงินออม' ของสัปดาห์นี้",
    "📊 อัปเดตตัวเลขเงินเก็บล่าสุดลงในแอปหรือสมุดจดให้เห็นความคืบหน้า",
    "☕ วันนี้เปลี่ยนจากซื้อกาแฟแบรนด์ดัง เป็นชงกินเองหรือซื้อร้านที่ถูกลงครึ่งราคา",
    "💬 ทักแชตถามไอเดียประหยัดเงินเจ๋งๆ จากเพื่อนที่เก่งเรื่องการเงิน 1 คน",
    "🛠️ หยิบของเก่าที่เกือบจะทิ้ง มาทำความสะอาดหรือซ่อมให้กลับมาใช้ได้อีกครั้ง",
    "✍️ จดนิสัยการเงินแย่ๆ 1 อย่างที่ตัวเองเลิกทำได้แล้ว ลงในสมุดบันทึก"
  ],
  "LOW_RISK_HIGH_DISC": [
    "🏦 เคลียร์ใบเสร็จเก่าๆ ออกจากกระเป๋าตังค์ และจัดเรียงแบงก์ให้เป็นระเบียบ",
    "⏳ จับเวลา 5 นาที เก็บกวาดโต๊ะทำงานให้โล่ง เพื่อลดความเครียดสะสม",
    "🧮 กดเครื่องคิดเลขคำนวณค่าชานม/กาแฟที่กินประจำ ว่า 1 ปีเสียเงินไปเท่าไหร่",
    "🌳 ออกไปเดินเล่น อาบน้ำอุ่น หรือดูคลิปตลก แทนการช้อปปิ้งแก้เครียด 1 ครั้ง",
    "🛟 เปิดแฟ้มหรือลิ้นชัก เพื่อเช็กว่าเอกสารสำคัญ (เช่น พาสปอร์ต, สมุดบัญชี) ยังอยู่ครบ",
    "📖 เปิดดูบิลค่าโทรศัพท์/อินเทอร์เน็ตเดือนล่าสุด ว่ามีค่าบริการแฝงที่เราไม่ได้ใช้ไหม",
    "🧾 จดชื่อคอร์สเรียนหรือหนังสือ 1 เล่ม ที่จะช่วยอัปสกิลเพิ่มรายได้ให้เราได้",
    "🔒 วันนี้ซ่อนแอปธนาคารหรือแอป e-Wallet ไว้ในโฟลเดอร์ลึกๆ 1 วันเต็ม",
    "💳 กดเช็กพอยต์ในแอปบัตรเครดิต/สมาชิก แล้วแลกเป็นส่วนลดซื้อของจำเป็น 1 ครั้ง",
    "🧮 กดเครื่องคิดเลข: 500 บาท x 365 วัน x 20 ปี เพื่อดูว่าต้องมีเงินเกษียณเท่าไหร่"
  ],
  "HIGH_RISK_MID_DISC": [
    "💰 กดโอนเงินเข้าบัญชี 'ใช้จ่ายตามใจ' 5% ของรายได้ แล้วใช้ก้อนนี้ซื้อของเล่นให้พอ",
    "✍️ ก่อนกดของลดราคา ให้พิมพ์ถามตัวเองใน Note ว่า 'ถ้าราคาเต็มจะยังซื้อไหม?'",
    "🧘 พิมพ์ระบายลง Note ทันทีเมื่อรู้สึกอิจฉาเพื่อนในโซเชียล เพื่อดึงสติตัวเอง",
    "📁 ลากแอปช้อปปิ้งทั้งหมดไปซ่อนไว้ในโฟลเดอร์หน้าสุดท้ายของมือถือ",
    "🎁 ปิดจอมือถือ แล้วนอนพักสายตาหรือฟังเพลงเงียบๆ 15 นาทีเป็นรางวัลให้ตัวเอง",
    "🔇 กด Mute โพสต์/Story ของคนที่ชอบโชว์ของหรูในโซเชียลชั่วคราว 1 วัน",
    "📦 หยิบของที่ไม่ได้ใช้แล้ว 1 ชิ้นออกมาถ่ายรูป เตรียมโพสต์ขายเป็นของมือสอง",
    "💡 พิมพ์ลง Note 1 บรรทัดถึงของที่ซื้อมาแล้วเสียดายที่สุด เพื่อเตือนใจไม่ให้ซ้ำรอย",
    "🔔 ตั้งนาฬิกาปลุกในมือถือเวลา 20.00 น. ด้วยชื่อ 'วันนี้ใช้เงินเกินงบไหม?'",
    "🧮 เอาเงินเก็บทั้งหมด หารด้วยค่าใช้จ่ายรายเดือน เพื่อดูว่าเราจะตกงานได้กี่เดือน"
  ],
  "MID_RISK_MID_DISC": [
    "🎟️ งดซื้อขนมหรือกาแฟ 1 วัน แล้วกดโอนเงินค่าขนมนั้นเข้าบัญชีเงินเก็บทันที",
    "📊 ไฮไลต์สีบิลรายจ่ายสัปดาห์นี้ (สีแดง=ของอยากได้, สีเขียว=ของจำเป็น)",
    "📺 เปิด YouTube ดูคลิปสรุปเรื่องลดหย่อนภาษี หรือสวัสดิการรัฐ ความยาวไม่เกิน 5 นาที",
    "🧴 ซื้อของใช้จำเป็น (เช่น สบู่, กระดาษทิชชู่) ยี่ห้อที่ถูกกว่าเดิม 1 ชิ้นมาทดลองใช้",
    "🏥 เสิร์ชอินเทอร์เน็ตเช็กชื่อโรงพยาบาลที่ครอบคลุมสิทธิประกันสังคมหรือประกันสุขภาพของเรา",
    "💵 กดย้ายเงิน 10% ของรายได้ เข้าบัญชีที่ไม่มีบัตร ATM และไม่ผูกแอปธนาคาร",
    "✂️ ขีดฆ่ารายการใช้จ่ายยิบย่อย 1 รายการของเมื่อวาน ที่ตั้งใจจะไม่ให้เกิดซ้ำในพรุ่งนี้",
    "📦 หากล่องเปล่า 1 ใบมาใส่ของที่ 'ซื้อมาแล้วไม่ได้ใช้' แล้ววางไว้ในจุดที่เห็นชัดๆ",
    "📉 กดจ่ายบิลบัตรเครดิตเพิ่มจากยอดขั้นต่ำ (อย่างน้อย 100 บาท) เพื่อลดยอดต้น",
    "📓 หยิบสมุดเล่มเล็ก 1 เล่มมาเขียนหน้าปกว่า 'ไอเดียหาเงิน' แล้วพกติดตัว"
  ],
  "LOW_RISK_MID_DISC": [
    "🚨 กดเปลี่ยนชื่อบัญชีเงินเก็บในแอปธนาคาร ให้เป็นชื่อเป้าหมาย (เช่น ทริปญี่ปุ่น)",
    "📱 กด Unsubscribe อีเมลแจ้งโปรโมชั่นจากร้านค้าที่ทำให้เสียเงินบ่อยที่สุด 1 ร้าน",
    "⏱️ ท้าทายตัวเองทำ 'No Spend Day' (งดใช้จ่ายทุกอย่างยกเว้นค่าเดินทาง) ให้จบ 1 วัน",
    "📖 หยิบหนังสือที่ดองไว้มาเปิดอ่าน 1 บท (หรือ 10 หน้า) แทนการไถแอปช้อปปิ้ง",
    "👕 คุ้ยตู้เสื้อผ้าหาชุดที่ซื้อมาแล้วยังไม่เคยใส่ แล้วรีดเตรียมไว้ใส่ในวันพรุ่งนี้",
    "🗑️ กดลบแอป Delivery หรือแอปเรียกรถที่ซ้ำซ้อนและไม่ได้ใช้งานออก 1 แอป",
    "🚫 เข้าไปที่การตั้งค่า แล้วกดยกเลิก Subscription รายเดือนที่ไม่ได้ใช้งานเกิน 1 เดือน",
    "💧 ล้างขวดน้ำส่วนตัวเตรียมไว้พกออกไปข้างนอก เพื่อลดค่าซื้อน้ำขวดจุกจิก",
    "🔐 กดเปลี่ยนรหัส PIN เข้าแอปธนาคารหลัก เพื่อกระตุกสติก่อนใช้เงิน",
    "💳 เข้าไปลบข้อมูลบัตรเครดิตที่เซฟผูกไว้กับแอปช้อปปิ้งออนไลน์ 1 แอป"
  ],
  "HIGH_RISK_LOW_DISC": [
    "🏦 จดกฎเหล็กใส่กระดาษ: 'ถ้าได้เงินพิเศษหรือโบนัส ต้องหักเก็บ 50% ทันที'",
    "🔇 กด Unfollow หรือ Mute เพจ/Influencer ที่ชอบ 'ป้ายยา' เป็นเวลา 1 สัปดาห์",
    "📝 เขียน Post-it ว่า 'จำเป็นจริงๆ ใช่ไหม?' แล้วแปะทับลงบนบัตรเครดิต",
    "⏰ แข็งใจทิ้งของไว้ในตะกร้า แล้วตั้งกฎว่าจะกดจ่ายเงินได้แค่ช่วง 2 ทุ่มเท่านั้น",
    "🔐 เอาบัตรเครดิตออกจากกระเป๋าตังค์ ไปซ่อนไว้ในลิ้นชักตู้เสื้อผ้า 1 วัน",
    "⏳ กดของที่อยากได้ใส่ตะกร้าทิ้งไว้ แล้วล็อกเอาต์ออกจากแอปเป็นเวลา 24 ชั่วโมง",
    "✍️ เขียนราคาของที่อยากได้ หารด้วย 30 วัน เพื่อดูว่าถ้ามันพังในเดือนเดียว เราจ่ายวันละเท่าไหร่",
    "💬 แคปรูปของที่อยากได้ ส่งเข้าแชตเพื่อนสนิท แล้วพิมพ์บอกว่า 'ช่วยห้ามฉันที'",
    "📴 เข้า Setting ในมือถือ เพื่อปิด Notification แอปช้อปปิ้งและแอป Delivery ทั้งหมด",
    "💵 เดินไปกดเงินสดมาใส่กระเป๋า เพื่อบังคับตัวเองให้จ่ายมื้อถัดไปด้วยเงินสด"
  ],
  "MID_RISK_LOW_DISC": [
    "🤖 กดตั้งค่าโอนเงินเก็บล่วงหน้า (Auto-transfer) ในแอปธนาคาร ทันทีที่เงินเดือนเข้า",
    "💳 จัดกระเป๋าตังค์ใหม่ เอาบัตรเครดิตออกให้หมด พกไปแค่เงินสดสำหรับใช้ 1 วัน",
    "📱 ลบไอคอนแอปช้อปปิ้งออกจากหน้า Home screen ให้หมด (เหลือไว้แค่ใน App Library)",
    "💵 ใส่เงินสดสำหรับค่ากินวันนี้ไว้ในซองแยก ถ้าหมดซองคือจบ ห้ามโอนเพิ่ม",
    "🖊️ หยิบมือถือมาเปิดแอป/Note เพื่อพิมพ์รายจ่ายทันทีที่เพิ่งโอนเงินหรือจ่ายสดเสร็จ",
    "📦 จัดแจงเอาของเก่า 1 ชิ้นไปทิ้งหรือบริจาค ก่อนที่จะกดยืนยันสั่งซื้อของใหม่แบบเดียวกัน",
    "📱 เปิด 2 แอปช้อปปิ้งเพื่อเทียบราคาสินค้าชนิดเดียวกัน (รวมค่าส่ง) ก่อนกดซื้อ",
    "🏷️ กดยกเลิกการสั่งซื้อชั่วคราว หากเช็กแล้วว่าวันนี้แอปไม่มีแจกคูปองส่งฟรี",
    "🍳 เปิดตู้เย็นหาวัตถุดิบทำเมนูล้างตู้เย็น 1 มื้อ แทนการกดสั่งอาหาร Delivery",
    "🚧 เข้าแอปธนาคารไปปรับลด 'วงเงินโอน/จ่ายสูงสุดต่อวัน' ให้เหลือแค่พอใช้จ่ายปกติ"
  ],
  "LOW_RISK_LOW_DISC": [
    "✍️ จดทักษะหรืองานอดิเรกของตัวเอง 3 ข้อลงกระดาษ ที่คนอื่นมักจะชอบมาขอให้เราช่วย",
    "💳 กดผูกบัญชีเพื่อตั้งหักจ่ายบิลค่าน้ำ/ค่าไฟ/มือถือ อัตโนมัติในแอปธนาคาร",
    "📱 โหลดแอปทำบัญชีรายรับ-รายจ่ายที่หน้าตาสวยๆ มาติดตั้งไว้ในมือถือ 1 แอป",
    "💬 ทักแชตไปถาม HR หรือเพื่อนร่วมงาน ว่าบริษัทมีสวัสดิการอะไรบ้างที่เราลืมใช้",
    "💰 กดโอนเศษเงินในบัญชี (เช่น ยอด 1,245 โอน 45 บาท) เข้าบัญชีเงินเก็บทันที",
    "🧮 กดเครื่องคิดเลขเทียบราคาต่อชิ้น/ต่อกรัม ของสินค้าแพ็กใหญ่ vs แพ็กเล็ก ก่อนหยิบลงตะกร้า",
    "📅 พิมพ์โน้ตวันเกิดคนในครอบครัวลงปฏิทินมือถือ แล้วพิมพ์ตัวเลข 'งบของขวัญ' กำกับไว้",
    "🍳 ลุกไปทำเมนูง่ายๆ เช่น ทอดไข่ หรือขนมปังปิ้ง ทานเอง 1 มื้อในวันนี้",
    "🔍 เสิร์ช Google ว่า 'สิทธิลดหย่อนภาษีปีล่าสุด' แล้วเซฟรูปตารางสรุปเก็บไว้ในมือถือ",
    "📝 เดินสำรวจห้องน้ำ/ห้องครัว แล้วจดของใช้ที่ใกล้หมดลง Note เพื่อรอซื้อวันจัดโปรโมชั่น"
  ]},
