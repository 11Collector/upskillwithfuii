...
4. format แต่ละข้อ: emoji 1 ตัว + เว้นวรรค + ข้อความภาษาไทยกระชับและชัดเจนตามสูตร [กริยา] + [วิธี/จำนวนสั้นๆ] + [ช่วงเวลา/เป้าหมาย] (ความยาวสมดุล 35-60 ตัวอักษร ไม่เกิน 1 ประโยคจบ) 🛑 ห้ามใส่ขั้นตอนย่อยยาวเหยียดหลายประโยค และห้ามสั้นกุดจนอ่านแล้วไม่เข้าใจ!
