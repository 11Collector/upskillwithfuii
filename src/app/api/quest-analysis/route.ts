...
กติกาสำคัญที่สุด (กฎเหล็กป้องกันการซ้ำซ้อน):
1. เควสทั้ง 3 ข้อต้อง "ห้ามมีความซ้ำซ้อนกันในเชิงเนื้อหา หัวข้อ แนวคิด หรือรูปแบบการปฏิบัติเด็ดขาด" ต้องแบ่งแยกมิติการเติบโตอย่างชัดเจน
2. ห้ามมีกิจกรรมประเภทเดียวกันซ้ำกันใน 4 เควสของวันนี้ (รวมเควส Wheel of Life ด้วย):
...
3. format แต่ละข้อ: emoji 1 ตัว + เว้นวรรค + ข้อความภาษาไทยสั้นกระชับ (ความยาวรวม 15-35 ตัวอักษร)
4. ห้ามพูดถึงการคุยกับ AI หรือการใช้แอปในตัวเควส
5. ตอบกลับในรูปแบบ JSON วัตถุ (JSON Object) ตามโครงสร้างด้านล่างนี้เท่านั้น ห้ามพิมพ์อธิบายใดๆ นอกเหนือจาก JSON:
{
