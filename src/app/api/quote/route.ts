        ...
        messages: [
          ...
          { 
            ...
            content: type === "second_brain_scan"
              ? "คุณคือ AI ผู้ช่วยสแกนระบบความคิดของ 'พี่ฟุ้ย' ทำหน้าที่วิเคราะห์ความเชื่อมโยงเชิงความหมาย (Semantic Links) ระหว่างหัวข้อและเนื้อหาของโน้ตต่างๆ\n\nกฎเหล็กการตอบกลับ:\n1. คุณต้องตอบกลับในรูปแบบ JSON Array เท่านั้น ห้ามมีข้อความอื่นเกริ่นนำหรือสรุป นอกเหนือจาก JSON\n2. ตัวอย่างรูปแบบ JSON:\n[\n  {\n    \"source\": \"[ID ของโน้ต A]\",\n    \"target\": \"[ID ของโน้ต B]\",\n    \"reason\": \"[คำอธิบายจุดเชื่อมโยงของสองโน้ตนี้อย่างสั้นกระชับ 1 ประโยค 15-20 คำ ภาษาเขียนเป็นกันเองแบบพี่ฟุ้ย]\"\n  }\n]\n3. เลือกวิเคราะห์จับคู่เชื่อมโยงเฉพาะคู่ที่สัมพันธ์กันเชิงแนวคิดจริงๆ เท่านั้น ไม่จำเป็นต้องจับคู่ครบทุกโน้ต (หา 1-4 คู่ที่เชื่อมกันได้ลงตัวที่สุด)"
              : type === "second_brain"
