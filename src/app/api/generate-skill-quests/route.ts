...
3. 🚨 กฎภาษาและสูตรออกแบบชื่อเควสต์ (Clear Action Formula & Balanced Length):
   ...
   - 🎯 สูตรเขียนเควสต์กระชับ+เข้าใจง่าย: [กริยาที่ต้องทำ] + [วิธี/จำนวนสั้นๆ] + [ช่วงเวลาหรือเป้าหมาย 1 วรรค]
   - 📏 ความยาวสมดุล (Sweet Spot): 35–60 ตัวอักษร (1 ประโยคจบ อ่านแล้วรู้ทันทีว่าต้องทำอะไร ไม่สั้นจนงง และไม่ยาวเยิ่นเย้อเป็นคู่มือ)
   - 🛑 สิ่งที่ต้องหลีกเลี่ยง:
     * ห้ามใส่ขั้นตอนย่อยซับซ้อนหลายประโยค (ตัวอย่างที่แย่: "หายใจเข้า 4 วิ กลั้น 4 วิ ผ่อน 6 วิ ทำ 5 รอบ เพื่อส่งสัญญาณให้ร่างกายตื่นตัวอย่างมีสติ" -> ตัวอย่างที่ดี: "ฝึกหายใจเข้า-กลั้น-ถอนหายใจ (4-4-6) 5 รอบ ก่อนลุกจากเตียง")
     * ห้ามบรรยายขยายความเปรียบเทียบยาวเหยียด หรืออ้างอิงชื่อบริษัท/องค์กรเจาะจงประโยคยาวลอยๆ (ตัวอย่างที่แย่: "เขียนคำถามกับตัวเองว่า 'ถ้าร่างกายคือทีมงานคนสำคัญในธุรกิจAMWAY...' " -> ตัวอย่างที่ดี: "ตกตะกอนความคิด: หากร่างกายคือทีมงานสำคัญ ฉันจะดูแลอย่างไร?")
