...
const HIGHLIGHTS = [
  "41 บทความจากประสบการณ์จริง ไม่ใช่ทฤษฎี",
...
export default function EbookPage() {
  ...
  return (
    <div className={sarabun.className} style={{ background: "#faf9f7", minHeight: "100vh", color: "#1a1a1a" }}>
      ...
      {/* Hero */}
      <section className="max-w-md mx-auto px-6 pt-12 pb-8 text-center">
        {/* Cover */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="mx-auto mb-8 w-40 rounded-xl overflow-hidden"
          style={{ boxShadow: "0 12px 40px rgba(123,24,24,0.18)" }}
        >
          <Image
            src="/ebook-cover.png"
            alt="สร้างก่อนพร้อม"
      ...
      <motion.section
        ...
        className="max-w-md mx-auto px-6 pb-6"
      >
      ...
      <motion.section
        ...
        className="max-w-md mx-auto px-6 pb-10"
      >
